...
public class ImageFragment extends Fragment {
    ...
    public static final int WELCOME_IMAGE = 1;
    ...
    public static int image2[] = {R.mipmap.small2, R.mipmap.large};

    public static ImageFragment newInstance(int param1, Context context, int style) {
        mContext = context;
        intentBack = (IntentBack) mContext;
        if (style == GOODS_DETAIL) {
            image = image2;
        }
